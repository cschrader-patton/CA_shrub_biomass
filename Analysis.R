...
VegCamp<-terra::vect("G:/OneDrive - USDA/WWETAC/All_Cal_veg_biomass/All_Cal_veg_and_biomass_APRX/All_Cal_veg_and_biomass.gdb", layer = "CNPS_VCAMP_InterimPts__Merge_stripped")

VegCamp<-project(VegCamp, CRSproject)
DF<-data.frame(VegCamp)
VegCamp_CNPS_DF<-DF %>%
  #filter(CNPS_Yes==1) %>%  
  #'Conif_ht','Hdwd_ht','Herb_ht','Hdwd_ht_txt','RegenTr_ht_txt','Herb_ht_txt' 'Conif_ht_txt','Shrub_ht','Shrub_ht_txt'
  select( c('SurveyID','Y_LAT','X_LONG','CNPS_Yes','RegenTree_ht','RegenTr_ht_txt'))
 

empty_cols <- c('RegenTr_hgt_cm')
#'RegenTr_hgt_cm','Herb_hgt_cm', 'Conif_hgt_cm','Hdwd_hgt_cm'
VegCamp_CNPS_DF[, empty_cols] <- NA



#VCSpecies<-read.csv("C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Plots/VegCamp/SurveyPlants.csv")
#VCSpecies<-read.csv("C:/Users/cschrader/Box/CalFire_April 2025/Plot Data/Plots/VegCamp/SurveyPlants.csv")

DF_RegenTr_ht1<-VegCamp_CNPS_DF %>%
  filter(is.na(VegCamp_CNPS_DF$CNPS_Yes))%>%
  mutate(
    RegenTr_hgt_cm = recode(RegenTr_ht_txt,
                         "0" = 0,
                      "<.5m" = 25,
                      "<1/2m" =25,
                      "<0.5 m" =25,
                      ...
                      .default = as.numeric(RegenTr_ht_txt)))

DF_RegenTr_ht2<-VegCamp_CNPS_DF %>%
  filter(VegCamp_CNPS_DF$CNPS_Yes==1)%>%
  mutate(
    RegenTr_hgt_cm = recode(RegenTree_ht,
                         "1" = 25,
                         "2" =75,
                         "3" =150,
                         "4" = 350,
                         ...
                         "998" = -998,
                         "NA" = NA_real_,
                         .default = as.numeric(RegenTree_ht)))


DF_RegenTr_ht_all <- merge(DF_RegenTr_ht1, DF_RegenTr_ht2, by = "SurveyID",all = TRUE)

# Export the data frame to a CSV file
write.csv(DF_RegenTr_ht_all, "C:\\Users\\cschrader\\Box\\CalFire_April 2025\\Plot Data\\Plots\\VegCamp\\DF_RegenTr_ht_all.csv", row.names = FALSE)

 ############ CSP DID NOT MODIFY AND LINES BELOW ######################################################################
# 
#     Project='VegCamp', 
...
writeVector(VDB_shrub_fin, 'C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/VDB_shrub.shp', overwrite=TRUE)
...
writeVector(LAVO_shrub_fin, 'C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/LAVO_shrub.shp', overwrite=TRUE)
...
writeVector(REDW_shrub_fin, 'C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/REDW_shrub.shp', overwrite=TRUE)
...
writeVector(R5_shrub_fin, 'C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/R5_shrub.shp', overwrite=TRUE)
...
# rm(list = ls())
# CRSproject<-"epsg:3310"
BLM<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/BLM_shrub.shp')
Landfire<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/Landfire_shrub.shp')
VegCamp<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/VegCamp_shrub.shp')
Slaton<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/Slaton_shrub.shp')
Slaton$PrimaryKey<-as.character(Slaton$PrimaryKey)
SoCal<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/SoCal_shrub.shp')
Chap<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/Chap_shrub.shp')
VDB<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/VDB_shrub.shp')
LAVO<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/LAVO_shrub.shp')
REDW<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/REDW_shrub.shp')
R5<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/R5_shrub.shp')
# 
TestAll<-rbind(BLM, Landfire, VegCamp, Slaton, SoCal, Chap, VDB, LAVO, REDW, R5)
terra::writeVector(TestAll, 'C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/AllDB_shrub_Oct25.shp', overwrite=TRUE)
# TestAll<-terra::vect('C:/Users/anduane/Box/CalFire_April 2025/Plot Data/Analysis/outputs/AllDB_shrub.shp')
